...
// class GoogleWalletBadge extends StatefulWidget {
//   GoogleWalletBadge({required this.designNotifier, required this.title});
//   final DesignModel designNotifier;
//   final String title;

//   @override
//   State<GoogleWalletBadge> createState() => _GoogleWalletBadge(designNotifier: designNotifier);
// }

// class _GoogleWalletBadge extends State<GoogleWalletBadge> {
// _GoogleWalletBadge({required this.designNotifier});
// final DesignModel designNotifier;
